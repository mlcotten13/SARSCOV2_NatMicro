...
if total_number_sequences >0 and total_number_sequences <=10:
	ytick_label_size = 8
elif total_number_sequences >10 and total_number_sequences <=30:
	ytick_label_size = 4
...
print(print_string_header, file=variant_catalog)
variant_catalog.close()
for key, value in list(occurrence.items()):
	...
	print(print_string, file=variant_catalog)
	variant_catalog.close()
...
for annotation in annotation_list:
	...
	print(print_string, file=simplified_annotation_table)	
...
plt.savefig(outprefix+'_differences.pdf', bbox_inches='tight', dpi=300)
plt.savefig(outprefix+'_differences.jpg', bbox_inches='tight', dpi=300)
